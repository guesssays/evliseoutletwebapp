...
/* === FINAL OVERRIDE: cashback / ETA всегда белые === */
html body :is(.badge--cashback,[data-badge="cashback"],.badge--eta,[data-badge="eta"]){
  color:#fff !important;
  -webkit-text-fill-color:#fff !important; /* на всякий случай для iOS */
  mix-blend-mode: normal !important;
  filter: none !important;
  opacity: 1 !important;
}

/* белим всё содержимое, включая иконки и вложенные элементы */
html body :is(.badge--cashback,[data-badge="cashback"],.badge--eta,[data-badge="eta"])
  :is(svg,svg *,i,.icon,span,b,strong){
  color:#fff !important;
  fill:#fff !important;
...
/* если внутри стояли "тёмные" utility-классы — глушим их */
html body :is(.badge--cashback,[data-badge="cashback"],.badge--eta,[data-badge="eta"])
  [style*="color"], 
html body :is(.badge--cashback,[data-badge="cashback"],.badge--eta,[data-badge="eta"])
  [class*="text-"],
...
/* опционально: если фон у бейджа светлый — сделай тёмную подложку для контраста */
 /* 
.badge--cashback,[data-badge="cashback"],
.badge--eta,[data-badge="eta"]{
  background: rgba(18,17,17,.92) !important;
